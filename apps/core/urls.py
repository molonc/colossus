...
url(r'^sequencing/samplesheet/(?P<pk>\d+)$', views.sequencing_get_samplesheet, name='sequencing_get_samplesheet'),
url(r'^sequencing/gsc_form/(?P<pk>\d+)$', views.SequencingGSCForm.as_view(), name='sequencing_get_gsc_form'),
