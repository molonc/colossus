...
url(r'^sequencing/get_samplesheet/(?P<pk>\d+)$', views.sequencing_get_samplesheet, name='sequencing_get_samplesheet'),
url(r'^sequencing/get_gsc_form/(?P<pk>\d+)$', views.sequencing_get_gsc_form, name='sequencing_get_gsc_form'),
