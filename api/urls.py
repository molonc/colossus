...
urlpatterns = [
    ...
    url(r'^jira/authenticate/$',
        views.jira_authenticate, name="jira_authenticate"),
    url(r'^jira/create/$',
        views.create_jira_ticket, name="jira_create_ticket"),
    url(r'^jira/projects/$',
        views.get_jira_projects, name="get_jira_projects"),
    url(r'^jira/users/$',
        views.get_jira_users, name="get_jira_users"),
]
