...
TENX_LIBRARY = ["name", "jira_ticket", "experimental_condition", "google_sheet",
                      ...
                      "tenxlibraryconstructioninformation__index_used",
...
TENX_SEQUENCING = ["tenx_pool__pool_name", "sequencing_instrument", "sequencer_id",
                   "sequencing_center", "sequencer_notes", "gsc_library_id", "tenxlane__flow_cell_id"]
